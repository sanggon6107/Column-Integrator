...
class UiMgr :
    ...
    def run_ui(self) :
        ...
        self.radio_button_duplicate_3 = tk.Radiobutton(self.frame_duplicate_button, text = "각 랏의 첫 검사만 남기고 중복 제거", value = DUPLICATE_OPTION.LEAVE_LAST_FROM_EACH_LOT, variable = self.__var_duplicate)
